...
Global $Checkbox_every, $Checkbox_extra, $Checkbox_linux, $Checkbox_show, $Checkbox_test, $Checkbox_verify, $Checkbox_win
Global $Combo_OS, $Group_games, $Input_dest, $Input_extra, $Input_name, $Input_title, $Input_OS, $List_games, $Pic_cover
;
...
Global $infofle, $inifle, $left, $line, $lines, $logfle, $manifest, $name, $open, $OS, $read, $res, $segment, $shell
Global $split, $state, $style, $text, $textdump, $title, $titlist, $top, $user, $version, $width, $winpos, $xpos, $ypos
...
Func MainGUI()
	Local $Group_cover, $Group_dest, $Group_down, $Label_cover, $Label_extra, $Label_OS, $Label_title
	;
	Local $all, $alpha, $cover, $dll, $every, $extras, $gamefold, $gamepic, $gamesfold, $lang
	Local $langs, $let, $mpos, $OSes, $OSget, $pid, $pth, $show, $val, $validate, $verify
	;
	$width = 590
	$height = 405
...
Func QueueGUI()
	...
	Local $Button_remove, $Button_start, $Button_stop, $Checkbox_files, $Checkbox_image, $Checkbox_other, $Checkbox_start
	Local $Checkbox_stop, $Combo_shutdown, $Group_auto, $Group_done, $Group_download, $Group_info, $Group_progress
	Local $Group_shutdown, $Group_stop, $Group_waiting, $Input_download, $Input_lang, $Input_OS, $List_done
	Local $List_waiting, $Progress_bar
	;
	Local $QueueGUI
	;
	...
	;
	$Button_start = GuiCtrlCreateButton("START", 460, 15, 60, 50)
	GUICtrlSetFont($Button_start, 8, 600)
	GUICtrlSetTip($Button_start, "Start downloading!")
	;
	$Button_stop = GuiCtrlCreateButton("STOP", 530, 15, 50, 50)
