...
; CheckOnGameDownload(), EnableDisableControls($state), FillTheGamesList(), GetWindowPosition()
; ParseTheManifest()
...
Global $Button_dest, $Button_down, $Button_exit, $Button_fix, $Button_fold, $Button_info, $Button_log, $Button_more
...
Global $extras, $file, $files, $flag, $game, $gamefold, $gamepic, $games, $gamesfle, $gogrepo, $GOGRepoGUI, $height
Global $icoD, $icoF, $icoI, $icoT, $icoX, $image, $imgfle, $infofle, $inifle, $lang, $left, $line, $lines, $logfle
Global $manifest, $minimize, $name, $open, $OS, $OSget, $pid, $read, $res, $segment, $shell, $shutdown, $split, $started
Global $state, $style, $text, $textdump, $title, $titlist, $top, $tot, $user, $val, $validate, $verifying, $version
Global $width, $winpos, $xpos, $ypos
...
Func QueueGUI()
	...
	Local $Button_removall, $Button_remove, $Button_start, $Button_stop, $Checkbox_check, $Checkbox_dos, $Checkbox_files
	...
	;
	Local $ind, $QueueGUI, $section, $shutopts, $swap, $t, $titles
	;
	...
	While 1
		...
		Case $msg = $Button_removall
			...
			$ans = MsgBox(262177, "Remove ALL Query", _
				...
				"Do you want to continue?", 0, $QueueGUI)
			If $ans = 1 Then
				FileDelete($downlist)
