...
; EnableDisableControls($state), FillTheGamesList(), ParseTheManifest()
...
Global $line, $lines, $logfle, $manifest, $name, $open, $OS, $read, $res, $segment, $shell, $split, $state, $text
...
Func MainGUI()
	Local $Group_cover, $Group_dest, $Label_cover, $Label_extra, $Label_OS, $Label_title
	;
