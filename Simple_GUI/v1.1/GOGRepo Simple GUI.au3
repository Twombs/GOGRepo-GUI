...
Global $OS, $OSget, $out, $outcome, $pid, $pos, $property, $repoGUI, $res, $resfle, $results, $resumeman, $ret, $shell, $show
Global $SimpleGUI, $size, $srcfld, $srcfle, $style, $target, $text, $textcol, $title, $titlist, $top, $unrar, $update, $updated
Global $user, $val, $version, $w, $warning, $width, $winpos, $wins, $wintit
;Global $innoextract
;
